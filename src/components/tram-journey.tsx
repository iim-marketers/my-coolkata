  ...
  return (
    <div className={className}>
      ...
      <div className="relative mt-20">
        <span className="absolute inset-x-0 top-3.25 h-px bg-border" />
        <span
          className="absolute top-3.25 left-0 h-px bg-terracotta transition-[width] duration-1000 ease-in-out"
        ...
        <span
          aria-hidden
          className="pointer-events-none absolute top-3.75 transition-[left,transform] duration-1000 ease-in-out motion-reduce:transition-none"
          style={{
            left: `${progress * 100}%`,
          ...
          {tramStops.map((s, n) => (
            <li key={s.name}>
              ...
              >
                ...
                <span
                  className={cn(
                    "max-w-18 text-center font-mono text-[0.5rem] leading-tight tracking-[0.06em] uppercase transition-colors sm:text-[0.56rem]",
                    n === i
                      ? "text-foreground"
